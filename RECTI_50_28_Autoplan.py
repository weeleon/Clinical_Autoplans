...
defaultPrescDose = 5040 #the absolute prescribed dose in cGy
...
#### RECTAL CANCER PREOPERATIVE 50.4GY PROTOCOL
#### 50.4Gy/28F Normo-fractionated prescribed to all PTVs
...
ScriptedRois = [external, femHeadLeft, femHeadRight, ptvT, ptvP, ptvE, wall5mmPtvE, complementExt5mmPtvE]
