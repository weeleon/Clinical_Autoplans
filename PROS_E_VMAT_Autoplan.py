...
MarginSubtractionType(pm,examination,transitionTSVtoE,colourPtvE,"PTV",ptvE,0.0,ptvTSV,0.8)
#
#
# ---------- GROW WALL STRUCTURES
#Create3DWallOrgan(pm,exam,sourceRoi,targetRoi,targetColour,inMargin,outMargin):
Create3DWallOrgan(pm,examination,ptvTSV,wall8mmPtvTSV,colourWallStructures,0.0,0.8)
#
